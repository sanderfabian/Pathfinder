...
const BachelorDegreeWithHonours = () => {
    ...
    const fetchData = async () => {
        try {
            const programCollection = collection(firestore, 'BachelorDegreeWithHonours');
        ...
        try {
            ...
            const deleteMajorPromises = majorDocs.docs.map(async (majorDoc) => {
                ...
                await Promise.all(subcollections.map(async (subcollection) => {
                    const subcollectionRef = collection(firestore, 'BachelorDegreeWithHonours', programId, 'Major', majorDoc.id, subcollection);
...
export default BachelorDegreeWithHonours;
