...
const ViewMDCourses = () => {
    ...
    const fetchCourses = async () => {
        try {
            const coreCoursesRef = collection(firestore, 'MasterDegree', programId, 'Major', majorId, 'CoreCourses');
            const electiveMajorCoursesRef = collection(firestore, 'MasterDegree', programId, 'Major', majorId, 'ElectiveMajorCourses');
    ...
    const handleDeleteCourse = async (courseId, subcollection) => {
        try {
            const courseRef = collection(firestore, 'MasterDegree', programId, 'Major', majorId, subcollection);
    ...
    const handleAddCourse = async () => {
        try {
            ...
            const courseRef = collection(firestore, 'MasterDegree', programId, 'Major', majorId, selectedSubcollection);
